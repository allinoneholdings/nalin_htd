...
const Group3 = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 p-10 justify-center backdrop-blur-md text-gray-300 rounded-xl transition-shadow duration-300 cursor-pointer">
      <div className="pl-30">
        <h2 className="text-3xl font-semibold mb-2 text-primary">KIDS DRIVING AGE 11 to 15</h2>
        <div className="overflow-hidden rounded-lg">
          <img
            src="http://howtodrive.lk/images/2019/01/11/IMG_9679-11---15.jpg"
            alt="group3"
      ...
      <div className="pt-10">
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-1">
            <li>Puzzles & Activity.</li>
            <li>Cycling & Road Safety.</li>
            <li>First Aid & Car Basics</li>
            <li>Real Car Simulation.</li>
            <li>Battery Remote Car Driving on Track</li>
            <li>First Aid.</li>
          </ul>
        </div>
        <button
          ...
          className="mt-3 bg-primary hover:bg-primary-dull text-black px-4 py-2 rounded transition"
        >
          Start Course
        </button>
      </div>
