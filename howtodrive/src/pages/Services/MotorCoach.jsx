  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 p-10 justify-center  backdrop-blur-md text-gray-100 rounded-xl transition-shadow duration-300 cursor-pointer">
            <div className='pl-30'>
                <h2 className="text-3xl font-semibold mb-5 text-primary">Driving Licence for Motor Coach & Motor Lorry</h2>
                <div className="overflow-hidden rounded-lg">
                    <img
                    src='http://howtodrive.lk/images/2018/09/14/IMG_9101.JPG'
                    alt='manualauto'
